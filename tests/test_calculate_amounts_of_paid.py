...
class TestAmountsOfPaid(unittest.TestCase):
    def test_get_airports(self):
        ...
        test_airport_ids = [1, 2, 264]
        expected = {1: 'Newark Airport', 2: 'Jamaica Bay', 264: 'N/A'}
    ...
    def test_get_total_amount(self):
        ...
        test_data = [{'RatecodeID': 1, 'tip_amount': 3.42, 'tolls_amount': 0.0, 'total_amount': 20.52},
                     ...
                     {'RatecodeID': None, 'tip_amount': 0.0, 'tolls_amount': 0.0, 'total_amount': 10.0},
                     {'RatecodeID': None, 'tip_amount': 0.0, 'tolls_amount': 0.0, 'total_amount': 20.0}]

        expected = [{'airport_id': 1, 'airport': 'Newark Airport', 'total_amount': 340.08},
                    {'airport_id': 264, 'airport': 'N/A', 'total_amount': 0}]

        actual = get_total_amount(data=test_data,
                                  cols=["RatecodeID", "tip_amount", "tolls_amount", "total_amount"],
                                  reporting_airp={1: 'Newark Airport', 264: 'N/A'},
                                  airp=[0, 1, 2, 3, 4, 5, 6, 99, 264])
